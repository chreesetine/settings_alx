document.addEventListener('DOMContentLoaded', function() {
    ...
    // AJAX form submission for updating the price
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    $('td:contains(' + response.category + ')').next().next().text(response.price);

                    // Optionally, you can update the other page using AJAX polling or WebSockets
